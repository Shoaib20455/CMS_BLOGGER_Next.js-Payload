...
export default function Footer({ variant = "absolute" }: FooterProps) {
  if (variant === "flow") {
    return <FlowFooter />;
  }
...
function FlowFooter() {
  return (
    <footer className="bg-[#012F42] text-white">
      <div className="mx-auto grid w-[calc(100%_-_40px)] max-w-[1082px] gap-12 py-10 sm:grid-cols-2 lg:grid-cols-[1.25fr_0.72fr_1fr_0.95fr] lg:gap-[86px]">
        <div>
          <Image
            ...
            width={109}
            height={80}
            className="h-[58px] w-[79px] object-contain"
          />

          <p className="mt-5 max-w-[260px] font-['Poppins'] text-[10px] font-medium leading-[17px] text-white">
          ...
          <div className="mt-9 flex gap-3">
            {["f", "x", "in", "ig"].map((item) => (
              <span
                key={item}
                className="flex h-6 w-6 items-center justify-center rounded-[3px] bg-[#003951] font-['DM_Sans'] text-[10px] font-bold text-white"
              >
                {item}
              </span>
            ))}
        ...
        <div>
          <h3 className="font-['Outfit'] text-[16px] font-semibold leading-6 text-[#FE8F02]">
            Quick Links
          </h3>
        ...
        <div>
          ...
          <div className="mt-4 space-y-[14px] font-['DM_Sans'] text-white">
            <div>
              <p className="flex items-center gap-1.5 text-[10px] font-semibold leading-[14px]">
                <PhoneIcon />
                Phone
              </p>
              <p className="mt-1.5 text-[12px] font-medium leading-[18px]">
                (555) 123-4567
              </p>
            </div>
      ...
      <div className="border-t border-[#003951]">
        <div className="mx-auto flex w-[calc(100%_-_40px)] max-w-[1082px] flex-col gap-4 py-6 font-['DM_Sans'] text-[10px] leading-[18px] text-white sm:flex-row sm:items-center sm:justify-between">
          <p>
          ...
          <div className="flex flex-wrap gap-8">
            ...
            <Link href="/terms-of-service" className="text-white no-underline">
              Terms of Service
            </Link>

            <Link href="/disclaimer" className="text-white no-underline">
              Disclaimer
            </Link>
          </div>
        </div>
...
function PhoneIcon() {
  return (
    <svg
      className="h-[10px] w-[10px] text-[#FE8F02]"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
    ...
    <>
      <div className="bb-blog-001">
        ...
        <div className={`bb-footer-003 ${top.description}`}>
          Box Truck Dispatching offers reliable and profit driven truck
          dispatching services across the United States. We help owner operators
          and fleets secure high-paying loads, reduce deadhead miles, and
        ...
        <div className={`bb-footer-006 ${top.heading}`}>Quick Links</div>
        ...
        <div className={`bb-footer-009 ${top.heading}`}>Our Services</div>
        ...
        <div className={`bb-footer-010 ${top.links}`}>
          {[
            ...
            <Link key={item} href="#services" className="bb-footer-008">
              {item}
            </Link>
          ))}
        </div>

        <div className={`bb-footer-011 ${top.heading}`}>Get In Touch</div>

        <svg
          className={`bb-footer-012 ${top.phoneIcon}`}
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
        ...
        <div className={`bb-footer-014 ${top.phoneValue}`}>
          (555) 123-4567
        </div>

        <svg
          className={`bb-footer-012 ${top.emailIcon}`}
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
        ...
        <div className={`bb-footer-014 ${top.emailValue}`}>
          info@avenuemh.com
        </div>

        <svg
          className={`bb-footer-012 ${top.locationIcon}`}
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
        ...
        <div className={`bb-footer-014 ${top.locationValue}`}>
          Serving All 48 States
        </div>
        ...
        <div className={`bb-footer-019 ${top.bottom}`}>
          {["Privacy Policy", "Terms of Service", "Disclaimer"].map(
            (policy) => (
              <Link key={policy} href="#policy" className="bb-footer-020">
                {policy}
              </Link>
            )
          )}
