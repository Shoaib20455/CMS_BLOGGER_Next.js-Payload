      ...
      <section className="mx-auto mt-20 w-[calc(100%_-_40px)] max-w-[1520px] overflow-hidden rounded-[10px] bg-[#012F42]">
        <div className="grid min-h-[585px] grid-cols-1 lg:grid-cols-2">
          <div className="flex flex-col justify-center px-6 py-10 sm:px-10 lg:px-[50px]">
            <h2 className="font-['Outfit'] text-[34px] font-bold leading-[44px] text-[#FE8F02] sm:text-[42px] sm:leading-[52px] lg:text-[48px] lg:leading-[60px]">
              Your Truck Is Ready.
            </h2>

            <h3 className="mt-5 font-['Outfit'] text-[24px] font-bold leading-[34px] text-white sm:text-[28px] sm:leading-[38px] lg:text-[30px] lg:leading-10">
              Are You Maximizing Every Mile?
            </h3>

            <p className="mt-5 max-w-[636px] font-['DM_Sans'] text-[16px] font-normal leading-[26px] text-white sm:text-[18px] sm:leading-7">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <button className="h-12 rounded-[5px] bg-[#FE8F02] px-5 font-['Outfit'] text-[18px] font-medium text-white transition-all duration-300 hover:scale-[1.03] hover:bg-[#E07D02] active:scale-95">
                Start Dispatching Today
              </button>

              <button className="h-12 rounded-[5px] border border-[#FE8F02] px-5 font-['Outfit'] text-[18px] font-medium text-[#FE8F02] transition-all duration-300 hover:scale-[1.03] hover:bg-[#FE8F02] hover:text-white active:scale-95">
