...
export default function IntroSections() {
  return (
    <>
      ...
      <div className="bb-intro-sections-010">
      ...
      <Image
          className="bb-intro-sections-013"
      ...
      <div className="bb-intro-sections-017">
        {[
          ...
          map((item) =>
          <div key={item.num} className="bb-intro-sections-018">
            <span className="bb-intro-sections-019">
              {item.num}
            </span>

            <span className="bb-intro-sections-020">
              {item.text}
            </span>
          </div>
          )}
      ...
      <section
        ...
        className="bb-intro-sections-021">
        ...
        <div className="bb-intro-sections-030">
          <Image
          ...
          <div className="bb-intro-sections-033">
            ...
            <div className="bb-intro-sections-036">
              ...
              { num: "05.", text: "Paperwork Service For Box Truck" }].
              map((item) =>
              <div key={item.num} className="bb-intro-sections-037">
                  <span className="bb-intro-sections-038">
                    {item.num}
                  </span>
                  <span className="bb-intro-sections-039">
                    {item.text}
                  </span>
                </div>
              )}
